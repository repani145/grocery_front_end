          ...
          <Card className="text-center shadow-sm">
            ...
            User Register
              ...
              <Button variant="primary">
                <Link to={'/signup/user_signup'} style={{ textDecoration: "none", color: "white" }}>User SignUP</Link>
              </Button>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col md={6} lg={5} className="mb-4 mx-auto">
          <Card className="text-center shadow-sm">
            ...
            Shop Register
              ...
              <Button variant="primary">
                <Link to={'/signup/vendor_signup'} style={{ textDecoration: "none", color: "white" }}>Vendor SignUP</Link>
              </Button>
            </Card.Body>
          </Card>
        </Col>
